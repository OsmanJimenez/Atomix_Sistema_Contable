...
public class Cuentas extends javax.swing.JPanel {
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        Cuentas_Agregar_1 p1 = new Cuentas_Agregar_1();
...
//CuentasAgregar_1 jFrame = new CuentasAgregar_1();
    ...
    private void BuscarTKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BuscarTKeyPressed
        // TODO add your handling code here:
         String[] titulos = {
            "Codigo", "Nombre", "Precio", "Descripcion", "Cuenta", "Auxiliar"
        };
        String[] registros = new String[50];

        String sql = "SELECT *FROM contabilidad WHERE codigo LIKE '%" + BuscarT.getText() + "%' "
     ...
     conexion a=new conexion();  
        ...
        try {
            ...
            while (rs.next()) {
                ...
                registros[5] = rs.getString("Auxiliar");
